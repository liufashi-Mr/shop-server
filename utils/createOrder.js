...
// 导入配置
const {AlipayBaseConfig} =require(path.resolve(__dirname,"../alipay_config.js"))
// 初始化
const alipay = new AlipaySDK(AlipayBaseConfig)
...
async function createOrder(goods) {
    ...
    formData.addField('returnUrl', 'http://localhost:8080/#/index/PaySuccess'); // 客户端支付成功后会同步跳回的地址
